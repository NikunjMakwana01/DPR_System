  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between">
        <div><h1 className="text-2xl font-bold">Notifications</h1><p className="text-gray-500">Your alerts and updates</p></div>
        ...
        <div className="space-y-3">
          {notifications.length ? notifications.map((n) => (
            <div
              ...
              className={`flex cursor-pointer items-start gap-4 rounded-lg border p-4 dark:border-gray-700 ${!n.isRead ? 'bg-primary-50/50 dark:bg-primary-900/10' : ''}`}
            >
